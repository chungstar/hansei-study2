		...
		/******/ {
			...
			/***/ 3: /***/ function (module, __webpack_exports__, __webpack_require__) {
				...
				function rect2bnd(rect) {
					var $document =
						external_root_jQuery_commonjs2_jquery_commonjs_jquery_amd_jquery_default()(document);
					return {
				...
				function posFromPlaceholder(placeholder) {
					var $placeholder =
						external_root_jQuery_commonjs2_jquery_commonjs_jquery_amd_jquery_default()(placeholder);
				...
				external_root_jQuery_commonjs2_jquery_commonjs_jquery_amd_jquery_default.a.fn.extend({
					...
					summernote: function summernote() {
						...
						this.each(function (idx, note) {
							var $note =
								external_root_jQuery_commonjs2_jquery_commonjs_jquery_amd_jquery_default()(note);
				...
				function createImage(url) {
					return external_root_jQuery_commonjs2_jquery_commonjs_jquery_amd_jquery_default.a
						.Deferred(function (deferred) {
							var $img =
								external_root_jQuery_commonjs2_jquery_commonjs_jquery_amd_jquery_default()('<img>');
							$img
								.one('load', function () {
									$img.off('error abort');
						...
						},
						{
							...
							value: function deleteRow(rng) {
								...
								var cellPos = row
									.children('td, th')
									.index(
										external_root_jQuery_commonjs2_jquery_commonjs_jquery_amd_jquery_default()(cell)
									);
							...
							value: function isLimited(pad, event) {
								...
								if (typeof event !== 'undefined') {
									if (
										...
										event.ctrlKey ||
										event.metaKey ||
										lists.contains([core_key.code.BACKSPACE, core_key.code.DELETE], event.keyCode)
									) {
										return false;
									}
								}
				...
				var Fullscreen_Fullscreen = /*#__PURE__*/ (function () {
					function Fullscreen(context) {
						...
						this.$codable = context.layoutInfo.codable;
						this.$window =
							external_root_jQuery_commonjs2_jquery_commonjs_jquery_amd_jquery_default()(window);
						this.$scrollbar =
							external_root_jQuery_commonjs2_jquery_commonjs_jquery_amd_jquery_default()(
								'html, body'
							);
								...
								this.context.memo('button.strikethrough', function () {
									return _this2
										.button({
											...
											click:
												_this2.context.createInvokeHandlerAndUpdateState('editor.strikethrough'),
										})
										.render();
								});
									...
									return _this2.ui
										.buttonGroup([
											...
											_this2.ui.dropdownCheck({
												...
												click:
													_this2.context.createInvokeHandlerAndUpdateState('editor.fontSizeUnit'),
											}),
										])
										.render();
								});
											...
											],
											{
												callback: function callback($node) {
													...
													$catcher
														...
														.mousedown(_this2.context.createInvokeHandler('editor.insertTable'))
